...
const backgroundColor = ["#e2e8f0", "#ddd", "#f1cfa6"];

const title = {
  "golden-kitty": "Высшая награда",
  "product-of-the-day": "Программа дня",
  "product-of-the-month": "Программа месяца",
  "product-of-the-week": "Программа недели",
};
