      ...
      <section className="relative z-10 pt-40 pb-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-base text-slate-900 font-semibold uppercase tracking-[0.1em] mb-10">
          ...
          <motion.div
            ...
            className="relative h-[280px] sm:h-[360px] md:h-[450px] lg:h-[500px] rounded-[2rem] overflow-hidden bg-white border border-black/[0.04] p-2 shadow-[0_0_80px_-15px_rgba(147,197,253,0.5),0_4px_25px_-5px_rgba(0,0,0,0.05)]"
          >
              ...
              {submitted ? (
                ...
                <>
                  <div className="text-center mb-8">
                    ...
                    <p className="text-white font-semibold text-sm uppercase tracking-[0.1em]">
                      СРЕДА, 15 АПРЕЛЯ / 16:00 МОСКВА / КИЕВ · 15:00 ЕВРОПА
                    </p>
                  </div>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <label className="flex items-start gap-3 cursor-pointer">
                        ...
                        <span className="text-xs text-white/70 font-light leading-relaxed">Я согласен(а) на <a href="/legal/privacy" target="_blank" rel="noopener" className="underline hover:text-white transition-colors">обработку персональных данных</a></span>
                      </label>
                      <label className="flex items-start gap-3 cursor-pointer">
                        <input type="checkbox" className="mt-1 w-4 h-4 rounded accent-white shrink-0" />
                        <span className="text-xs text-white/70 font-light leading-relaxed">Я согласен(а) получать <a href="/legal/offer" target="_blank" rel="noopener" className="underline hover:text-white transition-colors">информационную и рекламную рассылку</a></span>
                      </label>
                    </div>
                    <button
                      type="submit"
                    ...
                    <p className="text-sm text-white text-center font-semibold uppercase tracking-[0.1em]">
            ...
            <div className="p-8 md:p-10">
              {!submitted ? (
                <>
                  ...
                  <p className="text-sm text-white font-semibold uppercase tracking-[0.1em] mb-8">
                    СРЕДА, 15 АПРЕЛЯ / 16:00 МОСКВА / КИЕВ · 15:00 ЕВРОПА
                  </p>
