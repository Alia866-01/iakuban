      ...
      <section className="relative z-10 pt-40 pb-24 px-6 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="relative h-[280px] sm:h-[360px] md:h-[450px] lg:h-[500px] rounded-[2rem] overflow-hidden border border-black/[0.04] p-2 shadow-[0_0_80px_-15px_rgba(147,197,253,0.5),0_4px_25px_-5px_rgba(0,0,0,0.05)] bg-white"
          >
